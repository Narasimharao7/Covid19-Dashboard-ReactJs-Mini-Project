...
class Vaccination extends Component {
  ...
  getStatesAndDistricts = async () => {
    const {selectedStateId} = this.state
    const stateUrl = 'https://apis.ccbp.in/covid19-state-ids'
    ...
    if (response.ok === true) {
      ...
      if (districtResponse.ok === true) {
        const fetchedDistrictData = await districtResponse.json()
        const {districts} = fetchedDistrictData
        this.setState({
          statesList: states,
  ...
  renderSuccessView = () => {
    ...
    return (
      <div className="vaccination-content-container">
        <div className="site-and-vaccination-container">
          <div className="site-container">
            <img
              src="https://res.cloudinary.com/dkt3zutob/image/upload/v1739789238/covid19_dashboard_images/d72h1mvrkxez7u4cgmeg.png"
              alt="site"
          ...
          <div className="site-container">
            <img
              src="https://res.cloudinary.com/dkt3zutob/image/upload/v1739789757/covid19_dashboard_images/nsd9wte9prdrqx1ecjwi.png"
              alt="dose"
              className="site-image"
            />
            <div className="site-main-content">
        ...
        {/* below code is the getting line graphs but the required data is not
          ...
          <div className="line-chart-lg">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart width={500} height={300} data={chartData}>
                ...
                <Legend iconSize={10} fontSize={12} />
                {trend === 'dose' && (
                  <>
                    <Line
                      type="monotone"
  ...
  renderLoaderView = () => (
    <div id="state-loader-container" testid="vaccinationPageLoader">
      <LoaderSpinner />
    </div>
  )
